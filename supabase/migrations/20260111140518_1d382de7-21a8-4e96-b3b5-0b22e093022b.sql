-- Update create_offer_reminders function to use selected_state instead of is_selected
...
BEGIN
  -- Get offer details including selected_state
  SELECT o.id, o.instance_id, o.customer_id, o.selected_state
  INTO v_offer
  FROM offers o
  ...
  LOOP
    ...
    LOOP
      v_scheduled_at := p_completed_at + (v_reminder.months * INTERVAL '1 month');
