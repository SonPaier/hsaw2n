...
const CustomerDetailsDrawer = ({ customer, instanceId, open, onClose, onCustomerUpdated }: CustomerDetailsDrawerProps) => {
  ...
  return (
    <Sheet open={open} onOpenChange={() => { setIsEditing(false); onClose(); }}>
