    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          success: "group-[.toaster]:!bg-green-600 group-[.toaster]:!text-white group-[.toaster]:!border-green-600 [&_*]:!text-white [&_button]:!bg-white [&_button]:!text-black [&_button]:!border-0",
        },
      }}
      {...props}
    />
